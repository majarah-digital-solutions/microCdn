...
module.exports = (req, res, next) => {
	...
	const height = h || 0; // Get height from query string
	const width = w || 0; // Get width from query string
	// const quality = parseInt(q) < 100 ? parseInt(q) : 80; // Get quality from query string
	const quality = 80; // Get quality from query string

	const folder = `h${height}_w${width}_q${quality}`;
